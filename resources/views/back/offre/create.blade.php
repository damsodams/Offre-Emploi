...
<form style='margin-left:10px;' method="POST" action="{{route('offre.store')}}" enctype="multipart/form-data">
@csrf
 ...
 <div class="form-group">
    ...
    <button style='margin-bottom:10px;' type="submit" class="btn btn-primary center-block">
        Créer
    </button>
  </form>
